...
- (NSArray *)childPageInfo {
    return @[
             ...
             @{@"title":@"Registering is easy", @"image":[UIImage imageNamed:@"8"], @"bottomText":@"Return it to your local authority office by May 5th", @"backgroundColor":[UIColor colorWithRed:0.74 green:0.14 blue:0.2 alpha:1],@"textColor":[UIColor whiteColor]},
